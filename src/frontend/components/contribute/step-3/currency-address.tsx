...
export class CurrencyAddress extends React.Component<ICurrencyAddressProps, any> {
    ...
    private logos: { [key: string]: JSX.Element } = {
        'bitcoin': (
    ...
    render(): JSX.Element {
        return (
            <div>
                {this.logos[this.props.currency]}
